...
fs.copyFileSync(`${scriptPath}/../relax-step-utils-allure/reporterConfig.json`, `${scriptPath}/../../reporterConfig.json`);
console.info('reporterConfig.json created');
console.log('Configure mocha...');
fs.copyFileSync(`${scriptPath}/../relax-step-utils-allure/.mocharc.json`, `${scriptPath}/../../.mocharc.json`);
